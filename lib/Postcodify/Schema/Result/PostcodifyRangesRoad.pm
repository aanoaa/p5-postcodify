use utf8;
package Postcodify::Schema::Result::PostcodifyRangesRoad;
...
Postcodify::Schema::Result::PostcodifyRangesRoad
...
=head1 TABLE: C<postcodify_ranges_roads>

=cut

__PACKAGE__->table("postcodify_ranges_roads");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:rpN0VEDce2pY9A1yJiKOcQ
